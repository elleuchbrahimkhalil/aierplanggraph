...
function Ensure-WebApiRunning {
    ...
    Start-Process -FilePath "dotnet" -ArgumentList @("run", "--launch-profile", "WebApi") -WorkingDirectory $ProjectDir -WindowStyle Minimized -RedirectStandardOutput $logPath -RedirectStandardError $logPath | Out-Null
